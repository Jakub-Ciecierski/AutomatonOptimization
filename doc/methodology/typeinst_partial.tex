...
Section \ref{section:methodology} on the other hand, dive directly into implementation. It supplements the reader with needed knowledge of mathematical objects and data structures needed to thoroughly understanding the approach taken to solve our task. 
